...
// Put here because globals that change cant be in executable ram because of anti piracy.
// The explicit bounds keep these arrays complete so MENU_MULTI can use ARRAY_SIZE.
